                    ...
                    <li> 
                        <?php 
                            ...
                            if ($upload_akte != "" && $upload_kartu_keluarga != "") {
                                ...
                                if ($daftar['status_pendaftaran'] == 1) {
                                    echo '<font color="#2ecc71">Scan asli Akte kelahiran dan kartu keluarga 2 lembar<i class="fa fa-check"></i></font>';
                                }else if($daftar['status_pendaftaran'] >= 2){
                    ...
                    <li>
                        <?php 
                            ...
                            if ($foto_anak != "" && $foto_keluarga != "") {
                                ...
                                if ($daftar['status_pendaftaran'] == 1) {
                                    echo '<font color="#2ecc71">Foto siswa dan foto keluarga ukuran 2R<i class="fa fa-check"></i></font>';
                                }else if($daftar['status_pendaftaran'] >= 2){
                                    echo '<font color="#2ecc71">Foto siswa dan foto keluarga ukuran 2R<i class="fa fa-check"></i></font>';
                                }else{
                                    echo '<font color="#2ecc71">Foto siswa dan foto keluarga ukuran 2R<i class="fa fa-check"></i></font> <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                                }
                                
                            }else{
                                echo 'Foto siswa dan foto keluarga ukuran 2R <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                            }
