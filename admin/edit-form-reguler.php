...
$id = $_GET['id'];
$sql = "SELECT * FROM pendaftar_reguler WHERE id='$id'";
...
if(isset($_POST['edit'])) {
  ...
  $sql = "UPDATE pendaftar_reguler SET nama_siswa='$nama_siswa', ttl='$ttl', jk='$jk', alamat='$alamat', telp_siswa='$telp_siswa', agama='$agama', asal_sekolah='$asal_sekolah', ijazah='$ijazah', rapor='$rapor', prestasi='$prestasi', nama_ortu='$nama_ortu', pekerjaan='$pekerjaan', telp_ortu='$telp_ortu', pendidikan='$pendidikan' WHERE id='$id'";
                    ...
                    <div class="card-body">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" id="telp_siswa" maxlength="12" value="<?= $data['telp_siswa'] ?>" name="telp_siswa" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                          <label>Agama</label>
                          <div class="input-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="asal_sekolah" value="<?= $data['asal_sekolah'] ?>" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <div class="custom-file">
                              ...
                              <label class="custom-file-label" for="ijazahInputFile"><?= $data['ijazah'] ?></label>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <div class="custom-file">
                              ...
                              <label class="custom-file-label" for="raporInputFile"><?= $data['rapor'] ?></label>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <div class="custom-file">
                              ...
                              <label class="custom-file-label" for="prestasiInputFile"><?= $data['prestasi'] ?></label>
                            </div>
                          </div>
                        </div>
                      <!-- /.card-body -->
                    ...
                    <div class="card-body">
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="text" name="nama_ortu" value="<?= $data['nama_ortu'] ?>" class="form-control" id="exampleInputEmail1">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Pekerjaan Orang Tua</label>
                          <input type="text" name="pekerjaan" value="<?= $data['pekerjaan'] ?>" class="form-control" id="exampleInputEmail1">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">No. Telp/HP Orang Tua/Wali</label>
                          <input type="number" id="telp_ortu" value="<?= $data['telp_ortu'] ?>" maxlength="12" name="telp_ortu" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
